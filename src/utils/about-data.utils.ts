...
export const aboutData: AboutProps[] = [
  {
    introduction:
      "I'm passionate about what I do and committed to delivering the best results. With experience in front-end and\
       back-end development, I've been able to tackle various challenges in the field of software development.",
  },
  {
    introduction:
      "I firmly believe that continuous learning is the key to becoming an exceptional professional. Moreover, I see\
       ...
       contribute to this through my work.",
  },
  {
    introduction:
